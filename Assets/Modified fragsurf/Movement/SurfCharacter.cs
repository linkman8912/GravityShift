...
namespace Fragsurf.Movement
{
    ...
    public class SurfCharacter : MonoBehaviour, ISurfControllable
    {
        ...
        #region Grapple Flag
        // NEW: A public flag to indicate if the player is grappling.
        [HideInInspector]
        ...
        private void Update()
        {
            ...
            // NEW: If grappling, zero out vertical velocity to prevent SurfCharacter from applying extra falling force.
            if(isGrappling)
            {
                _moveData.velocity.y = 0f;
            }
        ...
        /// 1. Processes overlapping colliders and resolves penetration.
